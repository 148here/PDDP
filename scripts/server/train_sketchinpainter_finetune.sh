...
"${PYTHON_BIN}" train.py --config_file configs/sketchinpainter_finetune.yaml --name sketchinpainter_finetune --output "${OUTPUT_ROOT}/train" --load_path "${PDDP_CKPT}" --gpu 0 --seed 20260425 --cudnn_deterministic --amp "$@"
